...
namespace Control
{
    public partial class FrmInventoryOticom : Form
    {
        ...
        public FrmInventoryOticom()
        {
            InitializeComponent();
        }

        private void FrmInventoryOticom_Load(object sender, EventArgs e)
        {
        ...
        private void BtnPasteAnexo_Click(object sender, EventArgs e)
        {
            ...
            header.ArtCode.Name = AppSettings.settings.InventoryOticom.ColumnCode.ToString();
            header.Qty.Name = AppSettings.settings.InventoryOticom.ColumnUnits.ToString();
            header.Description.Name = AppSettings.settings.InventoryOticom.ColumnDescription.ToString();
            header.SerialNr.Name = AppSettings.settings.InventoryOticom.ColumnSerialNumber.ToString();
            header.DueDate.Name = AppSettings.settings.InventoryOticom.ColumnDueDate.ToString();
        ...
        private void dataGridView1_DragDrop(object sender, DragEventArgs e)
        {
            ...
            foreach (string ruta in archivos)
            {
                ...
                Headers header = new Headers();
                header.ArtCode.Name = AppSettings.settings.InventoryOticom.ColumnCode;
                header.Qty.Name = AppSettings.settings.InventoryOticom.ColumnUnits;
                header.Description.Name = AppSettings.settings.InventoryOticom.ColumnDescription;
                header.SerialNr.Name = AppSettings.settings.InventoryOticom.ColumnSerialNumber;
                header.DueDate.Name = AppSettings.settings.InventoryOticom.ColumnDueDate;
        ...
        private void AddNewItemAnexo(ItemAnexo itemInput, bool reloadGrid = true)
        {
            ItemAnexo? existingItem = items.FirstOrDefault(x => x.CodItem == itemInput.CodItem && x.SerialNumber == itemInput.SerialNumber && (x.DueDate == itemInput.DueDate || string.Equals(itemInput.DueDate, "")));
        ...
        private void LoadReport(List<ItemAnexo> list)
        {
            ...
            {
                ItemAnexoReport? itemExist = itemsReport.FirstOrDefault(x => x.CodItem == item.CodItem && x.SerialNumber == item.SerialNumber && x.DueDate == item.DueDate);
                ...
                {
                    itemsReport.Add(item.GetItemAnexoReport());
                }
        ...
        private void btnGenerateReport_Click(object sender, EventArgs e)
        {
            try
            {
                Functions.ExportToExcel(itemsReport, "Oticom");
            }
            catch (Exception ex)
            {
        ...
        private void BtnManualArticle_Click(object sender, EventArgs e)
        {
            ...
            manualArticle.productLine = eProductLine.Oticom;
        ...
        private void AddNewItemReceived(ItemAnexo itemInput)
        {
