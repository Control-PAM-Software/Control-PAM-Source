...
namespace Control
{
    public partial class FrmInventoryAtos : Form
    {
        ...
        public FrmInventoryAtos()
        {
            InitializeComponent();
        }

        private void FrmInventoryAtos_Load(object sender, EventArgs e)
        {
        ...
        private void BtnManualArticle_Click(object sender, EventArgs e)
        {
            ...
            manualArticle.productLine = eProductLine.Atos;
        ...
        {
            ItemAnexo? existingItem = itemsReceived.FirstOrDefault(x => x.CodItem == newItem.CodItem && x.SerialNumber == newItem.SerialNumber && (x.DueDate == newItem.DueDate || string.Equals(newItem.DueDate, "")));
