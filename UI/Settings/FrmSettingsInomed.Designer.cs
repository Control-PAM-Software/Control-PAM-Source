namespace Control
{
    partial class FrmSettingsInomed
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            // --- BLOQUE 1: INGRESO DE STOCK (Izquierda) ---
            // Código
            ...
            Name = "FrmSettingsInomed";
            Text = "Configuración Inomed";
            Load += FrmSettingsInomed_Load; // Corregido para que coincida con el nombre de la clase
            ResumeLayout(false);
            PerformLayout();
        }
        #endregion
