namespace Control
{
    partial class FrmSettingsAtos
    {
        ...
        private void InitializeComponent()
        {
            ...
            // --- BLOQUE 1: INGRESO DE STOCK (Columna Izquierda) ---
            // Código
            ...
            // Agregando controles en orden lógico
            Controls.Add(label1);
            Controls.Add(label2);
            Controls.Add(label3);
            Controls.Add(label4);
            ...
            Name = "FrmSettingsAtos";
            Text = "Configuración Atos";
            Load += FrmSettingsAtos_Load;
            ResumeLayout(false);
            PerformLayout();
        }
        #endregion
